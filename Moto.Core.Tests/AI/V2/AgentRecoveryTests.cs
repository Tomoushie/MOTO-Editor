...
public class AgentRecoveryTests : IDisposable
{
    ...
    [InlineData("Est-ce que tu veux que je crée ce fichier maintenant ?", true)]
    [InlineData("Voulez-vous que je vérifie que le code compile ?", true)]
    [InlineData("Do you want me to run the build?", true)]
